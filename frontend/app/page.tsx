...
import { MessageSquare, Plus, Menu, LogOut, Trash2 } from 'lucide-react'
    ...
    <div className="flex h-screen bg-[#212121]">
      ...
      <div className="flex-1 flex flex-col relative">
        ...
        <button
          ...
          className="absolute top-4 left-4 z-10 p-2 rounded-lg bg-gray-800 hover:bg-gray-700 text-white"
        >
