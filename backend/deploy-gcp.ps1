...
Write-Host ""
Write-Host "⚠️  IMPORTANT: Make sure you have created the following secrets in GCP Secret Manager:" -ForegroundColor Yellow
...
gcloud run deploy $SERVICE_NAME `
  ...
  --timeout 300 `
  --max-instances 10 `
  --set-env-vars "ENVIRONMENT=production,MODEL_ID=gpt-5,SUPABASE_URL=https://yxjboezofmbuebiuzqej.supabase.co,BUCKET_LEGAL=legal-docs,BUCKET_IMAGES=images,ALLOWED_ORIGINS=http://localhost:3000,https://your-frontend-url.vercel.app" `
